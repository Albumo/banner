...
gulp.task('watch', function () {
    ...
    gulp.watch([src_path.js + 'custom.js'], ['min-js']);
...
gulp.task('build-all', gulpsync.async([
    ['clean-dev', 'clean', 'build-all-enum']
]));
...
// ****************************** BUILD ALL END****************************** //
gulp.task('default', [
    'clean', 'clean-dev', 'replacePlaceholder', 'pug-dev', 'sass-dev', 'images-general-dev', 'images-content-dev', 'images-svgSprite-dev', 'js-dev','min-js', 'fonts-dev', 'browsersync-server', 'watch'
]);